...
INSERT INTO
    student (studentId, studentName, gender, address, email)
VALUES
    (
        1,
        'John Doe',
    ...
    (
        ...
        'Phurpa Wangchuk',
        'M',
        '102 Orange St City J',
        'phurpa.rodriguez@example.com'
    ),
    (
        12,
        'Dann Astony',
...
INSERT INTO
    student_assignment (
        assignmentId,
        assignment_numeric_grade,
        assignment_letter_grade,
        assignment_submission_date,
        assignment_graded_date,
        assignment_returned_date,
        studentId
    )
VALUES
    (
...
VALUES
    ...
    (9, 9, 9, 87, 'B+', 1, 2),
    (10, 10, 10, 93, 'A', 1, 2),
    (11, 11, 1, null, null, 0, 2),
    (12, 12, 2, null, null, 1, 2),
    (13, 13, 3, null, null, 1, 2),
    (14, 1, 8, 40, 'F', 0, 2),
    (15, 1, 7, 85, 'B+', 0, 2),
    (16, 2, 3, 45, 'F', 0, 2),
    (17, 2, 4, 88, 'B+', 0, 2),
...
INSERT INTO
    course_instructor (id, courseId, instructorId)
VALUES
    (1, 1, 1),
    (2, 2, 2),
    (3, 3, 3),
...
INSERT INTO
    course_assignment (id, courseId, assignmentId)
VALUES
    (1, 1, 1),
    (2, 1, 2),
    (3, 1, 3),
