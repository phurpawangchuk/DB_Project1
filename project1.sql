CREATE TABLE `assignment` (
  ...
  `assign_description` varchar(255) DEFAULT NULL,
  `assign_created_date` date DEFAULT NULL
...
INSERT INTO `assignment` (`assignmentId`, `assign_due_date`, `assign_description`, `assign_created_date`) VALUES
...
INSERT INTO `course_instructor` (`id`, `courseId`, `instructorId`) VALUES
(1, 1, 1),
(2, 2, 2),
(3, 3, 3),
(4, 4, 4),
...
INSERT INTO `student` (`studentId`, `fullName`, `gender`, `address`, `email`) VALUES
...
CREATE TABLE `student_assignment` (
  `assignmentId` int NOT NULL,
  `assignment_numeric_grade` int DEFAULT NULL,
  `assignment_letter_grade` varchar(2) DEFAULT NULL,
  `assignment_submission_date` date DEFAULT NULL,
  `assignment_graded_date` date DEFAULT NULL,
  `assignment_returned_date` date DEFAULT NULL,
...
INSERT INTO `student_assignment` (`assignmentId`, `assignment_numeric_grade`, `assignment_letter_grade`, `assignment_submission_date`, `assignment_graded_date`, `assignment_returned_date`, `studentId`) VALUES
...
CREATE TABLE `student_course` (
  ...
  `studentId` int DEFAULT NULL,
  `courseId` int DEFAULT NULL,
  `stdcourse_numeric_grade` int DEFAULT NULL,
  `stdcourse_letter_grade` varchar(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `student_course` (`id`, `studentId`, `courseId`, `stdcourse_numeric_grade`, `stdcourse_letter_grade`) VALUES
(1, 1, 1, 90, 'A'),
(2, 2, 2, 85, 'B+'),
(3, 3, 3, 92, 'A'),
(4, 4, 4, 88, 'B+'),
